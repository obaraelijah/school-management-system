"""
URL configuration for smartEdConnect project.
...
schema_view = get_schema_view(
    openapi.Info(
        title="SmartEdConnect API",
        default_version='v1',
        description="SmartEdConnect Educational Management System API",
        terms_of_service="https://www.example.com/terms/",
        contact=openapi.Contact(email="smartedconnect.io"),
